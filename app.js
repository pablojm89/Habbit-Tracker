...
const DENSE_STRENGTH_BENCHMARKS = {
  ...
  // Tanda 2 de gimnasio (orientativos).
  decline_bench_press: { axis: "ratio", levels: [0.8, 1.05, 1.3, 1.55] },
  close_grip_bench_press: { axis: "ratio", levels: [0.65, 0.9, 1.1, 1.3] },
  floor_press: { axis: "ratio", levels: [0.7, 0.95, 1.15, 1.4] },
  machine_chest_press: { axis: "ratio", levels: [0.6, 0.9, 1.15, 1.4] },
  decline_db_press: { axis: "ratio", levels: [0.55, 0.8, 1.0, 1.2] },
  cable_chest_fly: { axis: "ratio", levels: [0.2, 0.35, 0.5, 0.65] },
  db_chest_fly: { axis: "ratio", levels: [0.2, 0.3, 0.4, 0.5] },
  pec_deck: { axis: "ratio", levels: [0.4, 0.6, 0.8, 1.0] },
  seated_barbell_overhead_press: { axis: "ratio", levels: [0.5, 0.7, 0.9, 1.1] },
  push_press: { axis: "ratio", levels: [0.65, 0.9, 1.1, 1.3] },
  arnold_press: { axis: "ratio", levels: [0.3, 0.45, 0.6, 0.75] },
  machine_shoulder_press: { axis: "ratio", levels: [0.45, 0.65, 0.85, 1.05] },
  landmine_press: { axis: "ratio", levels: [0.3, 0.45, 0.6, 0.75] },
  cable_lateral_raise: { axis: "ratio", levels: [0.06, 0.1, 0.14, 0.18] },
  db_front_raise: { axis: "ratio", levels: [0.12, 0.2, 0.28, 0.36] },
  rear_delt_fly: { axis: "ratio", levels: [0.1, 0.18, 0.25, 0.32] },
  skull_crusher: { axis: "ratio", levels: [0.3, 0.45, 0.6, 0.75] },
  db_overhead_triceps_extension: { axis: "ratio", levels: [0.2, 0.3, 0.4, 0.5] },
  machine_dip: { axis: "ratio", levels: [0.5, 0.8, 1.0, 1.2] },
  pendlay_row: { axis: "ratio", levels: [0.7, 0.95, 1.2, 1.45] },
  t_bar_row: { axis: "ratio", levels: [0.7, 1.0, 1.25, 1.5] },
  chest_supported_db_row: { axis: "ratio", levels: [0.4, 0.6, 0.8, 1.0] },
  machine_row: { axis: "ratio", levels: [0.6, 0.85, 1.05, 1.25] },
  wide_grip_lat_pulldown: { axis: "ratio", levels: [0.55, 0.8, 1.0, 1.2] },
  neutral_grip_lat_pulldown: { axis: "ratio", levels: [0.6, 0.85, 1.05, 1.25] },
  straight_arm_pulldown: { axis: "ratio", levels: [0.25, 0.4, 0.55, 0.7] },
  db_pullover: { axis: "ratio", levels: [0.2, 0.3, 0.4, 0.5] },
  barbell_shrug: { axis: "ratio", levels: [0.8, 1.2, 1.5, 1.8] },
  db_shrug: { axis: "ratio", levels: [0.5, 0.8, 1.0, 1.2] },
  preacher_curl: { axis: "ratio", levels: [0.25, 0.4, 0.5, 0.65] },
  incline_db_curl: { axis: "ratio", levels: [0.15, 0.25, 0.35, 0.45] },
  cable_curl: { axis: "ratio", levels: [0.25, 0.4, 0.55, 0.7] },
  reverse_curl: { axis: "ratio", levels: [0.15, 0.25, 0.35, 0.45] },
  wrist_curl: { axis: "ratio", levels: [0.2, 0.3, 0.4, 0.5] },
  hack_squat: { axis: "ratio", levels: [0.8, 1.3, 1.8, 2.3] },
  goblet_squat: { axis: "ratio", levels: [0.25, 0.4, 0.55, 0.7] },
  pause_squat: { axis: "ratio", levels: [0.85, 1.3, 1.55, 1.8] },
  box_squat: { axis: "ratio", levels: [0.9, 1.4, 1.65, 1.9] },
  sumo_deadlift: { axis: "ratio", levels: [1.25, 1.75, 2.0, 2.5] },
  trap_bar_deadlift: { axis: "ratio", levels: [1.4, 1.9, 2.2, 2.7] },
  stiff_leg_deadlift: { axis: "ratio", levels: [0.9, 1.3, 1.6, 1.9] },
  single_leg_db_rdl: { axis: "ratio", levels: [0.3, 0.5, 0.7, 0.9] },
  barbell_good_morning: { axis: "ratio", levels: [0.4, 0.6, 0.8, 1.0] },
  db_reverse_lunge: { axis: "ratio", levels: [0.3, 0.5, 0.7, 0.9] },
  db_step_up: { axis: "ratio", levels: [0.25, 0.45, 0.65, 0.85] },
  hip_thrust_machine: { axis: "ratio", levels: [1.0, 1.5, 2.0, 2.5] },
  cable_kickback: { axis: "ratio", levels: [0.1, 0.2, 0.3, 0.4] },
  hip_abduction_machine: { axis: "ratio", levels: [0.5, 0.8, 1.0, 1.2] },
  hip_adduction_machine: { axis: "ratio", levels: [0.5, 0.8, 1.0, 1.2] },
  seated_leg_curl: { axis: "ratio", levels: [0.4, 0.65, 0.85, 1.05] },
  seated_calf_raise: { axis: "ratio", levels: [0.5, 0.8, 1.0, 1.2] },
  leg_press_calf_raise: { axis: "ratio", levels: [1.0, 1.5, 2.0, 2.5] },
  cable_crunch: { axis: "ratio", levels: [0.3, 0.5, 0.7, 0.9] },
  pallof_press: { axis: "ratio", levels: [0.1, 0.2, 0.3, 0.4] },
...
const denseExerciseCatalog = [
  ...
  ...[
    ...
    { id: "close_grip_bench_press", name: "Press banca agarre cerrado", category: "push", family: "bench_press", icon: "dumbbell", defaultScheme: "S5x5", defaultRestSeconds: 180 },
    { id: "floor_press", name: "Press en suelo con barra", category: "push", family: "bench_press", icon: "dumbbell", defaultScheme: "S5x5", defaultRestSeconds: 180 },
    { id: "machine_chest_press", name: "Press de pecho en máquina", category: "push", family: "bench_press", icon: "dumbbell", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "decline_db_press", name: "Press declinado con mancuernas", category: "push", family: "bench_press", loadPattern: "dumbbell_pair", icon: "dumbbell", defaultScheme: "S3x8", defaultRestSeconds: 120 },
    { id: "cable_chest_fly", name: "Aperturas en polea (cruce)", category: "push", family: "chest_isolation", icon: "dumbbell", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "db_chest_fly", name: "Aperturas con mancuernas", category: "push", family: "chest_isolation", loadPattern: "dumbbell_pair", icon: "dumbbell", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "pec_deck", name: "Contractora (pec deck)", category: "push", family: "chest_isolation", icon: "dumbbell", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "seated_barbell_overhead_press", name: "Press militar sentado con barra", category: "push", family: "accessory", icon: "arrow-big-up", defaultScheme: "S5x5", defaultRestSeconds: 180 },
    { id: "push_press", name: "Push press", category: "push", family: "accessory", icon: "arrow-big-up", defaultScheme: "S5x3", defaultRestSeconds: 180 },
    { id: "arnold_press", name: "Press Arnold", category: "push", family: "accessory", loadPattern: "dumbbell_pair", icon: "arrow-big-up", defaultScheme: "S3x8", defaultRestSeconds: 120 },
    { id: "machine_shoulder_press", name: "Press de hombro en máquina", category: "push", family: "accessory", icon: "arrow-big-up", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "landmine_press", name: "Press landmine", category: "push", family: "accessory", repsPerSide: true, icon: "arrow-big-up", defaultScheme: "S3x8", defaultRestSeconds: 120 },
    { id: "cable_lateral_raise", name: "Elevaciones laterales en polea", category: "push", family: "shoulder_isolation", repsPerSide: true, icon: "move-horizontal", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "db_front_raise", name: "Elevaciones frontales con mancuernas", category: "push", family: "shoulder_isolation", loadPattern: "dumbbell_pair", icon: "arrow-up-from-line", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "rear_delt_fly", name: "Pájaros (deltoides posterior)", category: "pull", family: "shoulder_health", loadPattern: "dumbbell_pair", icon: "arrow-left-to-line", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "skull_crusher", name: "Press francés (skull crusher)", category: "push", family: "elbow_extension", icon: "arrow-down-to-line", defaultScheme: "S3x10", defaultRestSeconds: 60 },
    { id: "db_overhead_triceps_extension", name: "Extensión de tríceps con mancuerna (dos manos)", category: "push", family: "elbow_extension", icon: "arrow-up-from-line", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "machine_dip", name: "Fondos en máquina", category: "push", family: "elbow_extension", icon: "arrow-down-to-line", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "pendlay_row", name: "Remo Pendlay", category: "pull", family: "barbell_row", icon: "arrow-left-to-line", defaultScheme: "S5x5", defaultRestSeconds: 180 },
    { id: "t_bar_row", name: "Remo en T", category: "pull", family: "barbell_row", icon: "arrow-left-to-line", defaultScheme: "S3x8", defaultRestSeconds: 120 },
    { id: "chest_supported_db_row", name: "Remo con apoyo en pecho (mancuernas)", category: "pull", family: "db_row", loadPattern: "dumbbell_pair", icon: "arrow-left-to-line", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "machine_row", name: "Remo en máquina", category: "pull", family: "cable_row", icon: "arrow-left-to-line", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "wide_grip_lat_pulldown", name: "Jalón agarre ancho", category: "pull", family: "lat_pulldown", icon: "arrow-down-to-line", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "neutral_grip_lat_pulldown", name: "Jalón agarre neutro/cerrado", category: "pull", family: "lat_pulldown", icon: "arrow-down-to-line", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "straight_arm_pulldown", name: "Pullover en polea (brazos rectos)", category: "pull", family: "lat_isolation", icon: "arrow-down-to-line", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "db_pullover", name: "Pullover con mancuerna", category: "pull", family: "lat_isolation", icon: "arrow-left-to-line", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "barbell_shrug", name: "Encogimientos con barra", category: "pull", family: "traps", icon: "arrow-left-to-line", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "db_shrug", name: "Encogimientos con mancuernas", category: "pull", family: "traps", loadPattern: "dumbbell_pair", icon: "arrow-left-to-line", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "preacher_curl", name: "Curl predicador (barra/EZ)", category: "pull", family: "elbow_flexion", icon: "biceps-flexed", defaultScheme: "S3x10", defaultRestSeconds: 60 },
    { id: "incline_db_curl", name: "Curl inclinado con mancuernas", category: "pull", family: "elbow_flexion", loadPattern: "dumbbell_pair", icon: "biceps-flexed", defaultScheme: "S3x10", defaultRestSeconds: 60 },
    { id: "cable_curl", name: "Curl en polea", category: "pull", family: "elbow_flexion", icon: "biceps-flexed", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "reverse_curl", name: "Curl inverso (agarre prono)", category: "pull", family: "elbow_flexion", icon: "biceps-flexed", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "wrist_curl", name: "Curl de muñeca", category: "pull", family: "forearm", icon: "biceps-flexed", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "hack_squat", name: "Sentadilla hack", category: "legs", family: "squat_weighted", icon: "chevrons-down", defaultScheme: "S3x8", defaultRestSeconds: 120 },
    { id: "goblet_squat", name: "Sentadilla goblet", category: "legs", family: "squat_weighted", icon: "chevrons-down", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "pause_squat", name: "Sentadilla con pausa", category: "legs", family: "squat_weighted", icon: "chevrons-down", defaultScheme: "S3x5", defaultRestSeconds: 180 },
    { id: "box_squat", name: "Sentadilla al cajón", category: "legs", family: "squat_weighted", icon: "chevrons-down", defaultScheme: "S5x5", defaultRestSeconds: 180 },
    { id: "sumo_deadlift", name: "Peso muerto sumo", category: "legs", family: "hinge_weighted", icon: "anchor", defaultScheme: "S5x3", defaultRestSeconds: 180 },
    { id: "trap_bar_deadlift", name: "Peso muerto con barra hexagonal", category: "legs", family: "hinge_weighted", icon: "anchor", defaultScheme: "S5x5", defaultRestSeconds: 180 },
    { id: "stiff_leg_deadlift", name: "Peso muerto piernas rígidas", category: "legs", family: "hinge_weighted", icon: "anchor", defaultScheme: "S3x8", defaultRestSeconds: 120 },
    { id: "single_leg_db_rdl", name: "Peso muerto rumano a una pierna (mancuernas)", category: "legs", family: "hinge_weighted", loadPattern: "dumbbell_pair", repsPerSide: true, icon: "anchor", defaultScheme: "S3x8", defaultRestSeconds: 90 },
    { id: "barbell_good_morning", name: "Good morning con barra", category: "legs", family: "hinge_weighted", icon: "anchor", defaultScheme: "S3x8", defaultRestSeconds: 120 },
    { id: "db_reverse_lunge", name: "Zancada atrás con mancuernas", category: "legs", family: "lunge", loadPattern: "dumbbell_pair", repsPerSide: true, bodyweightContributionPct: 85, icon: "footprints", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "db_step_up", name: "Step-up con mancuernas", category: "legs", family: "lunge", loadPattern: "dumbbell_pair", repsPerSide: true, bodyweightContributionPct: 85, icon: "footprints", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "hip_thrust_machine", name: "Hip thrust en máquina", category: "legs", family: "hip_thrust", icon: "arrow-big-up", defaultScheme: "S3x10", defaultRestSeconds: 90 },
    { id: "cable_kickback", name: "Patada de glúteo en polea", category: "legs", family: "hip_thrust", repsPerSide: true, icon: "arrow-big-up", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "hip_abduction_machine", name: "Abductores en máquina", category: "legs", family: "hip_isolation", icon: "chevrons-down", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "hip_adduction_machine", name: "Aductores en máquina", category: "legs", family: "hip_isolation", icon: "chevrons-down", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "seated_leg_curl", name: "Curl femoral sentado", category: "legs", family: "hamstring_isolation", icon: "chevrons-down", defaultScheme: "S3x10", defaultRestSeconds: 60 },
    { id: "seated_calf_raise", name: "Elevación de gemelos sentado", category: "legs", family: "calves", icon: "footprints", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "leg_press_calf_raise", name: "Gemelos en prensa", category: "legs", family: "calves", icon: "footprints", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "cable_crunch", name: "Crunch en polea", category: "core", family: "core_weighted", icon: "target", defaultScheme: "S3x12", defaultRestSeconds: 60 },
    { id: "pallof_press", name: "Press Pallof", category: "core", family: "core_weighted", repsPerSide: true, icon: "target", defaultScheme: "S3x12", defaultRestSeconds: 60 },
  ].map((gym) => ({
    nature: "weighted",
    allowedNatures: ["weighted"],
    bodyweightContributionPct: 0,
...
const denseTransferIdMeta = {
  ...
  close_grip_bench_press: { patterns: { horizontal_push: 1 }, muscles: { triceps: 0.85, chest: 0.7, front_delt: 0.4 }, specificity: 0.2 },
  floor_press: { patterns: { horizontal_push: 1 }, muscles: { chest: 0.7, triceps: 0.8, front_delt: 0.4 }, specificity: 0.2 },
  machine_chest_press: { patterns: { horizontal_push: 0.9 }, muscles: { chest: 0.9, triceps: 0.5, front_delt: 0.4 }, specificity: 0.1 },
  decline_db_press: { patterns: { horizontal_push: 1 }, muscles: { chest: 0.9, triceps: 0.5, front_delt: 0.3 }, specificity: 0.2 },
  cable_chest_fly: { patterns: { horizontal_push: 0.4 }, muscles: { chest: 0.95, front_delt: 0.3 }, specificity: 0.1 },
  db_chest_fly: { patterns: { horizontal_push: 0.4 }, muscles: { chest: 0.95, front_delt: 0.3 }, specificity: 0.1 },
  pec_deck: { patterns: { horizontal_push: 0.4 }, muscles: { chest: 0.95, front_delt: 0.25 }, specificity: 0.1 },
  seated_barbell_overhead_press: { patterns: { vertical_push: 1 }, muscles: { front_delt: 0.9, triceps: 0.6, side_delt: 0.4 }, specificity: 0.2 },
  push_press: { patterns: { vertical_push: 0.9, squat: 0.2 }, muscles: { front_delt: 0.85, triceps: 0.6, side_delt: 0.35, quads: 0.25, core_ext: 0.3 }, specificity: 0.25 },
  arnold_press: { patterns: { vertical_push: 1 }, muscles: { front_delt: 0.9, side_delt: 0.5, triceps: 0.5 }, specificity: 0.2 },
  machine_shoulder_press: { patterns: { vertical_push: 0.9 }, muscles: { front_delt: 0.9, triceps: 0.55, side_delt: 0.4 }, specificity: 0.1 },
  landmine_press: { patterns: { vertical_push: 0.7, horizontal_push: 0.4 }, muscles: { front_delt: 0.8, chest: 0.5, triceps: 0.6, core_ext: 0.3 }, specificity: 0.2 },
  cable_lateral_raise: { patterns: { vertical_push: 0.15 }, muscles: { side_delt: 0.95 }, specificity: 0.1 },
  db_front_raise: { patterns: { vertical_push: 0.25 }, muscles: { front_delt: 0.95 }, specificity: 0.1 },
  rear_delt_fly: { patterns: { horizontal_pull: 0.4 }, muscles: { rear_delt: 0.95, upper_back: 0.5 }, specificity: 0.1 },
  skull_crusher: { patterns: { horizontal_push: 0.2 }, muscles: { triceps: 0.95 }, specificity: 0.1 },
  db_overhead_triceps_extension: { patterns: { vertical_push: 0.2 }, muscles: { triceps: 0.95 }, specificity: 0.1 },
  machine_dip: { patterns: { vertical_push: 0.6, horizontal_push: 0.3 }, muscles: { triceps: 0.85, chest: 0.6, front_delt: 0.4 }, specificity: 0.1 },
  pendlay_row: { patterns: { horizontal_pull: 1, hinge: 0.2 }, muscles: { upper_back: 0.9, lats: 0.7, biceps: 0.5, core_ext: 0.3 }, specificity: 0.2 },
  t_bar_row: { patterns: { horizontal_pull: 1 }, muscles: { upper_back: 0.9, lats: 0.75, biceps: 0.5 }, specificity: 0.15 },
  chest_supported_db_row: { patterns: { horizontal_pull: 1 }, muscles: { upper_back: 0.9, lats: 0.7, biceps: 0.5, rear_delt: 0.3 }, specificity: 0.1 },
  machine_row: { patterns: { horizontal_pull: 1 }, muscles: { upper_back: 0.9, lats: 0.7, biceps: 0.5 }, specificity: 0.1 },
  wide_grip_lat_pulldown: { patterns: { vertical_pull: 0.65 }, muscles: { lats: 0.9, upper_back: 0.5, biceps: 0.4 }, specificity: 0.1 },
  neutral_grip_lat_pulldown: { patterns: { vertical_pull: 0.65 }, muscles: { lats: 0.9, biceps: 0.55, upper_back: 0.4 }, specificity: 0.1 },
  straight_arm_pulldown: { patterns: { vertical_pull: 0.3, straight_arm: 0.5 }, muscles: { lats: 0.95, triceps: 0.2, core_flex: 0.2 }, specificity: 0.15 },
  db_pullover: { patterns: { vertical_pull: 0.25, straight_arm: 0.4 }, muscles: { lats: 0.8, chest: 0.5, triceps: 0.3 }, specificity: 0.15 },
  barbell_shrug: { patterns: { vertical_pull: 0.1 }, muscles: { upper_back: 0.95, forearms_grip: 0.4 }, specificity: 0.1 },
  db_shrug: { patterns: { vertical_pull: 0.1 }, muscles: { upper_back: 0.95, forearms_grip: 0.5 }, specificity: 0.1 },
  preacher_curl: { patterns: { vertical_pull: 0.15 }, muscles: { biceps: 0.95 }, specificity: 0.1 },
  incline_db_curl: { patterns: { vertical_pull: 0.15 }, muscles: { biceps: 0.95 }, specificity: 0.1 },
  cable_curl: { patterns: { vertical_pull: 0.2 }, muscles: { biceps: 0.95, forearms_grip: 0.3 }, specificity: 0.1 },
  reverse_curl: { patterns: { vertical_pull: 0.15 }, muscles: { forearms_grip: 0.75, biceps: 0.5 }, specificity: 0.1 },
  wrist_curl: { patterns: {  }, muscles: { forearms_grip: 0.95 }, specificity: 0.05 },
  hack_squat: { patterns: { squat: 0.9 }, muscles: { quads: 0.95, glutes_hams: 0.5 }, specificity: 0.15 },
  goblet_squat: { patterns: { squat: 1 }, muscles: { quads: 0.85, glutes_hams: 0.55, core_ext: 0.3 }, specificity: 0.15 },
  pause_squat: { patterns: { squat: 1 }, muscles: { quads: 0.9, glutes_hams: 0.6, core_ext: 0.35 }, specificity: 0.25 },
  box_squat: { patterns: { squat: 1, hinge: 0.2 }, muscles: { quads: 0.8, glutes_hams: 0.7, core_ext: 0.35 }, specificity: 0.25 },
  sumo_deadlift: { patterns: { hinge: 0.9, squat: 0.3 }, muscles: { glutes_hams: 0.9, quads: 0.5, core_ext: 0.6, forearms_grip: 0.4 }, specificity: 0.25 },
  trap_bar_deadlift: { patterns: { hinge: 0.8, squat: 0.4 }, muscles: { glutes_hams: 0.85, quads: 0.6, core_ext: 0.6, forearms_grip: 0.4 }, specificity: 0.2 },
  stiff_leg_deadlift: { patterns: { hinge: 1 }, muscles: { glutes_hams: 0.95, core_ext: 0.6 }, specificity: 0.2 },
  single_leg_db_rdl: { patterns: { hinge: 0.9 }, muscles: { glutes_hams: 0.9, core_ext: 0.4 }, specificity: 0.3 },
  barbell_good_morning: { patterns: { hinge: 1 }, muscles: { glutes_hams: 0.9, core_ext: 0.7 }, specificity: 0.25 },
  db_reverse_lunge: { patterns: { squat: 0.7, hinge: 0.25 }, muscles: { quads: 0.8, glutes_hams: 0.75 }, specificity: 0.2 },
  db_step_up: { patterns: { squat: 0.75 }, muscles: { quads: 0.85, glutes_hams: 0.65 }, specificity: 0.2 },
  hip_thrust_machine: { patterns: { hinge: 0.7 }, muscles: { glutes_hams: 0.95 }, specificity: 0.1 },
  cable_kickback: { patterns: { hinge: 0.4 }, muscles: { glutes_hams: 0.95 }, specificity: 0.1 },
  hip_abduction_machine: { patterns: { squat: 0.1 }, muscles: { glutes_hams: 0.85 }, specificity: 0.05 },
  hip_adduction_machine: { patterns: { squat: 0.1, range_strength: 0.2 }, muscles: { glutes_hams: 0.6, quads: 0.2 }, specificity: 0.05 },
  seated_leg_curl: { patterns: { hinge: 0.4 }, muscles: { glutes_hams: 0.9 }, specificity: 0.1 },
  seated_calf_raise: { patterns: { squat: 0.05 }, muscles: { calves: 0.95 }, specificity: 0.05 },
  leg_press_calf_raise: { patterns: { squat: 0.1 }, muscles: { calves: 0.95 }, specificity: 0.05 },
  cable_crunch: { patterns: { core_compression: 0.9 }, muscles: { core_flex: 0.95 }, specificity: 0.1 },
  pallof_press: { patterns: { core_anti_ext: 0.8 }, muscles: { core_flex: 0.7, core_ext: 0.5 }, specificity: 0.15 },
...
function runDenseSelfTests() {
  ...
  test("S: progresión — 5x5 fácil sube ≤+5%; rango 10/9/8 pide 9 reps a la misma carga", () => {
    ...
    return (
      ...
      range && range.externalLoadKg === 60 && range.repsPerSet === 9
    );
  });
  ...
  test("gym tanda 2: 54 variantes con id-meta, benchmark, formato Fuerza y sin ids duplicados", () => {
    const ids = ["decline_bench_press", "close_grip_bench_press", "floor_press", "machine_chest_press", "decline_db_press", "cable_chest_fly", "db_chest_fly", "pec_deck", "seated_barbell_overhead_press", "push_press", "arnold_press", "machine_shoulder_press", "landmine_press", "cable_lateral_raise", "db_front_raise", "rear_delt_fly", "skull_crusher", "db_overhead_triceps_extension", "machine_dip", "pendlay_row", "t_bar_row", "chest_supported_db_row", "machine_row", "wide_grip_lat_pulldown", "neutral_grip_lat_pulldown", "straight_arm_pulldown", "db_pullover", "barbell_shrug", "db_shrug", "preacher_curl", "incline_db_curl", "cable_curl", "reverse_curl", "wrist_curl", "hack_squat", "goblet_squat", "pause_squat", "box_squat", "sumo_deadlift", "trap_bar_deadlift", "stiff_leg_deadlift", "single_leg_db_rdl", "barbell_good_morning", "db_reverse_lunge", "db_step_up", "hip_thrust_machine", "cable_kickback", "hip_abduction_machine", "hip_adduction_machine", "seated_leg_curl", "seated_calf_raise", "leg_press_calf_raise", "cable_crunch", "pallof_press"];
    const allIds = denseExerciseCatalog.map((exercise) => exercise.id);
    const unique = new Set(allIds).size === allIds.length;
    const ok = ids.every((id) => {
      const exercise = findDenseExerciseById(id);
      return exercise && exercise.nature === "weighted" && denseTransferIdMeta[id] && DENSE_STRENGTH_BENCHMARKS[id] && denseStrengthApplies(exercise) && denseIsStrengthScheme(denseDefaultScheme(exercise));
    });
  ...
  test("fuerza: martillo 3x10 completo propone 3x12 con la misma carga por mancuerna", () => {
    const exercise = denseExerciseById("db_hammer_curl");
    const entry = computeDenseEntry({ exercise_id: exercise.id, nature: "weighted", scheme: "S3x10", weight_per_dumbbell_kg: 12.5, external_load_kg: 25, reps_done: [10, 10, 10], effort: "N", rest_seconds: 60 });
    const next = denseStrengthNextBlock(exercise, entry);
    return next?.scheme === "S3x12" && next.load === 12.5 && !denseStrengthNextBlock(exercise, { ...entry, failed: true }) && !denseStrengthNextBlock(exercise, entry, "low");
  });
  test("fuerza: ciclo 8/10/12 solo sube carga al cerrar las tres series de 12", () => {
    const exercise = denseExerciseById("db_hammer_curl");
    const entry = { nature: "weighted", scheme: "S3x12", reps_done: [12, 12, 12], weight_per_dumbbell_kg: 12.5, effort: "E" };
    const next = denseStrengthNextBlock(exercise, entry);
    return next?.scheme === "S3x8" && next.load > 12.5 && !denseStrengthNextBlock(exercise, { ...entry, reps_done: [14, 14, 8] });
  });
  test("fuerza: cero reps no se convierte en una serie completa ni infla el total", () => {
    const entry = computeDenseEntry({ nature: "weighted", scheme: "S3x10", external_load_kg: 25, reps_done: [10, 10, 0], total_reps: 30, effort: "N" });
    return entry.total_reps === 20 && entry.reps_done.length === 3 && !denseStrengthPerformance(entry).complete && denseParseRepsDone("10,10,0")[2] === 0 && denseParseRepsDone("").length === 0;
  });
  test("fuerza: cambiar descanso solo cambia la duracion indicada, no carga ni objetivo", () => {
    const base = { scheme: "S3x8-12", type: "load", loadKey: "weight_per_dumbbell_kg", weightPerDumbbellKg: 12.5, repsPerSet: 11, totalReps: 33 };
    return [60, 90, 120, 180].every((rest) => {
      const next = denseStrengthRestSuggestion(base, rest);
      return next.weightPerDumbbellKg === 12.5 && next.totalReps === 33 && next.title.includes(denseFormatRest(rest));
    });
  });
  test("fuerza: descarga usa carga por mancuerna y no el peso del par", () => {
    const exercise = denseExerciseById("db_hammer_curl");
    state.denseTrainingEntries = Array.from({ length: 5 }, (_, i) => computeDenseEntry({ id: `unit-deload-${i}`, exercise_id: exercise.id, nature: "weighted", scheme: "S3x10", date: `2026-09-${10 + i}`, created_at: `2026-09-${10 + i}T12:00:00Z`, weight_per_dumbbell_kg: i ? 12.5 : 20, external_load_kg: i ? 25 : 40, reps_done: [10, 10, 10], effort: i ? "H" : "N" }));
    const base = { scheme: "S3x10", type: "load", loadKey: "weight_per_dumbbell_kg", weightPerDumbbellKg: 12.5, externalLoadKg: 25, direction: "hold" };
...
function denseTrainingFormMarkup(defaults, { includePicker = false, modal = false, submitLabel = "Guardar marca Dense" } = {}) {
  ...
  const suggestion = denseStrengthRestSuggestion(denseProgressionSuggestion(activeExercise, readiness, defaults.scheme), Number(defaults.restSeconds));
  return `
...
function denseRepsDoneBoxesHtml(scheme, values = [], targetReps = 0) {
  const parts = denseStrengthParts(scheme);
  if (!parts) return "";
  return Array.from({ length: parts.sets }, (_, index) => {
    const value = values[index];
    return `<input type="number" inputmode="numeric" min="0" max="100" step="1" name="repsDone${index + 1}" value="${value !== undefined && value !== "" ? escapeAttr(String(value)) : ""}" placeholder="${denseStrengthTargetReps(scheme, targetReps)}" aria-label="Reps serie ${index + 1}" />`;
  }).join("");
}

function denseRepsDoneField(defaults) {
  const values = denseParseRepsDone(defaults.repsDone);
  const parts = denseStrengthParts(defaults.scheme);
  const target = denseStrengthTargetReps(defaults.scheme, defaults.strengthTargetReps || Number(defaults.totalReps) / parts.sets);
  return `
    <div class="field is-full reps-done-field">
      <div data-strength-target>${denseStrengthTargetField(defaults.scheme, target)}</div>
      <span>Reps por serie (deja en blanco las que clavaste)</span>
      <div class="reps-done-grid" data-reps-done>${denseRepsDoneBoxesHtml(defaults.scheme, values, target)}</div>
    </div>
  `;
}
...
function denseReadRepsDone(form, scheme) {
  ...
  return boxes.map((box) => box.value.trim() === "" ? denseStrengthFormTarget(form, scheme) : Math.max(0, Number(box.value) || 0));
}
...
function denseSyncRepsDoneBoxes(form, scheme) {
  ...
  grid.innerHTML = denseRepsDoneBoxesHtml(scheme, current, denseStrengthFormTarget(form, scheme));
}

function denseStrengthTargetField(scheme, target) {
  const parts = denseStrengthParts(scheme);
  return parts?.isRange ? `<label class="field"><span>Objetivo de reps por serie</span><input type="number" name="strengthTargetReps" inputmode="numeric" min="${parts.repsMin}" max="${parts.repsMax}" step="1" value="${denseStrengthTargetReps(scheme, target)}"></label>` : "";
}

function denseStrengthFormTarget(form, scheme) {
  return denseStrengthTargetReps(scheme, form?.querySelector("[name='strengthTargetReps']")?.value);
}
...
function handleInput(event) {
  ...
  if (event.target.matches("#denseTrainingForm [name='strengthTargetReps']")) {
    const form = event.target.closest("form");
    const scheme = form.querySelector("[name='scheme']:checked").value;
    denseSyncRepsDoneBoxes(form, scheme);
    updateDenseStrengthTotal(form);
  }
...
function saveDenseTrainingForm(form) {
  ...
  const targetRepsPerMin = isometric
    ? 0
    : strength
      ? denseStrengthFormTarget(form, scheme)
  ...
  const targetTotalReps = isometric ? 0 : strength ? strength.sets * targetRepsPerMin : denseTotalFromRepsPerSet(targetRepsPerMin, scheme) || 0;
  const totalReps = isometric
    ? 0
    : strength && repsDone.length
    ? repsDone.reduce((sum, reps) => sum + reps, 0)
  ...
  const failed =
    ...
    (data.effort === "fallo" || (usesHold && holdRounds && totalHoldSeconds < targetTotalHoldSeconds) ||
      (!isMicro && !usesHold && targetTotalReps > 0 && (totalReps > 0 || (strength && repsDone.length)) && totalReps < (strength ? targetTotalReps * 0.8 : targetTotalReps)));
  const now = new Date().toISOString();
  const raw = {
    ...
    target_reps_per_set: strength ? targetRepsPerMin : null,
...
function applyDenseFormTargets(form, { resetStaleLoad = false } = {}) {
  ...
  const suggestion = denseStrengthRestSuggestion(denseProgressionSuggestion(exercise, readiness, scheme), Number(form.querySelector("[name='restSeconds']:checked")?.value));
  ...
  const strength = denseStrengthParts(scheme);
  const targetField = form.querySelector("[data-strength-target]");
  if (strength && targetField) targetField.innerHTML = denseStrengthTargetField(scheme, suggestion?.repsPerSet || strength.reps);
...
function updateDenseSchemeSelection(input) {
  ...
  if (input.name === "restSeconds") {
    const exercise = denseExerciseById(form.querySelector("[name='exerciseId']").value);
    const active = { ...exercise, nature: form.querySelector("[name='nature']").value };
    const scheme = form.querySelector("[name='scheme']:checked").value;
    const suggestion = denseStrengthRestSuggestion(denseProgressionSuggestion(active, denseFormReadiness(form), scheme), Number(input.value));
    const rec = form.querySelector("[data-recommendation]");
    if (rec) rec.innerHTML = renderDenseProgressionSuggestion(active, suggestion);
    const summary = form.querySelector(".dense-set-modal-summary > strong");
    if (summary) summary.textContent = `${denseStrengthSchemeLabel(scheme)} · descanso ${denseFormatRest(Number(input.value))}`;
    refreshIcons();
    return;
  }
...
function updateDenseStrengthTotal(form) {
  ...
  totalInput.value = done.length ? done.reduce((sum, reps) => sum + reps, 0) : parts.sets * denseStrengthFormTarget(form, scheme);
}
...
// session's scheme (or its next completed 3-set block), else a mid-range default
...
function denseDefaultScheme(exercise) {
  ...
  if (last && allowed.includes(last.scheme)) return denseStrengthNextBlock(exercise, last)?.scheme || last.scheme;
...
function densePlannedTargetRange(exercise, scheme, src = denseTargetSource(exercise, scheme)) {
  ...
  if (denseIsLoadExercise(exercise)) {
    const suggestion = denseProgressionSuggestion(exercise, "normal", scheme);
    const load = denseSuggestionLoadValue(suggestion);
    if (!load) return "";
...
function densePlannedTargetValue(exercise, scheme) {
  ...
  if (denseIsLoadExercise(exercise)) {
    ...
    const load = denseSuggestionLoadValue(suggestion);
    if (load) return `${suggestion.loadKey === "added_load_kg" ? "+" : ""}${formatKg(load)}${suggestion.loadKey === "weight_per_dumbbell_kg" ? " c/u" : ""}`;
    return "-";
  }
...
function denseEstimatedStrengthSuggestion(exercise, scheme, readiness = "normal") {
  ...
  return {
    ...
    estimated: true,
    title: `${denseStrengthSchemeLabel(scheme)} · ${loadKey === "weight_per_dumbbell_kg" ? "2×" : loadKey === "added_load_kg" ? "+" : ""}${formatKg(shown)} · descanso ${denseFormatRest(restSeconds)}`,
    reason: source.cross
...
function denseStrengthTargetReps(scheme, value) {
  const parts = denseStrengthParts(scheme);
  return parts ? Math.max(parts.repsMin, Math.min(parts.repsMax, Math.round(Number(value) || parts.reps))) : 0;
}

function denseStrengthPerformance(entry) {
  const parts = denseStrengthParts(entry.scheme);
  if (!parts) return { target: 0, minimum: 0, complete: false };
  const target = denseStrengthTargetReps(entry.scheme, entry.target_reps_per_set || Number(entry.target_total_reps) / parts.sets);
  const actual = Array.isArray(entry.reps_done) ? entry.reps_done : [];
  const minimum = actual.length ? Math.min(...actual.map(Number)) : Math.floor(Number(entry.total_reps || 0) / parts.sets);
  return { target, minimum, complete: (!actual.length || actual.length === parts.sets) && minimum >= target };
}

function denseStrengthFieldLoad(exercise, entry) {
  if (exercise.loadPattern === "dumbbell_pair") return entry.weight_per_dumbbell_kg !== undefined && entry.weight_per_dumbbell_kg !== null && entry.weight_per_dumbbell_kg !== "" ? Number(entry.weight_per_dumbbell_kg) : Number(entry.external_load_kg || 0) / 2;
  return Number(exercise.nature === "weighted_calisthenics" ? entry.added_load_kg ?? 0 : entry.external_load_kg ?? 0);
}

// Advance compatible three-set blocks from the latest completed mark, not an older max.
function denseStrengthNextBlock(exercise, entry, readiness = "normal") {
  if (!entry || !["weighted", "weighted_calisthenics"].includes(exercise.nature) || entry.nature !== exercise.nature ||
      entry.failed || !["N", "E", "VE"].includes(entry.effort || "N") || readiness === "low" || !denseStrengthPerformance(entry).complete) return null;
  const scheme = { S3x8: "S3x10", S3x10: "S3x12", S3x12: "S3x8" }[entry.scheme];
  if (!scheme || !denseAllowedSchemes(exercise).includes(scheme)) return null;
  const load = denseStrengthFieldLoad(exercise, entry);
  if (!Number.isFinite(load) || load < 0 || (!load && exercise.nature === "weighted")) return null;
  return { scheme, load: scheme === "S3x8" ? Math.max(load + 0.5, denseRoundLoad(load * 1.025)) : load };
}

function denseStrengthRestSuggestion(suggestion, seconds) {
  const parts = denseStrengthParts(suggestion?.scheme);
  if (!parts || !seconds) return suggestion;
  const prefix = suggestion.loadKey === "weight_per_dumbbell_kg" ? "2×" : suggestion.loadKey === "added_load_kg" ? "+" : "";
  const value = suggestion.type === "load" ? `${prefix}${formatKg(denseSuggestionLoadValue(suggestion))}` : `${suggestion.totalReps} reps`;
  return { ...suggestion, restSeconds: seconds, title: `${denseStrengthSchemeLabel(suggestion.scheme)}${parts.isRange ? ` (${suggestion.repsPerSet} reps)` : ""} · ${value} · descanso ${denseFormatRest(seconds)}` };
}

// Fixed schemes use effort-based load steps; compatible 3-set blocks and
// rep ranges complete their rep progression before increasing load.
function denseStrengthProgressionSuggestion(exercise, entry, scheme, readiness = "normal", nextBlock = null) {
  const parts = denseStrengthParts(scheme);
  ...
  if (nextBlock) {
    const loadKey = exercise.loadPattern === "dumbbell_pair" ? "weight_per_dumbbell_kg" : exercise.nature === "weighted_calisthenics" ? "added_load_kg" : "external_load_kg";
    return denseMaybeDeload({ ...base, type: "load", loadKey, direction: "up", tone: "green", step: 1,
      repsPerSet: parts.reps, totalReps: parts.sets * parts.reps,
      externalLoadKg: loadKey === "external_load_kg" ? nextBlock.load : "",
      addedLoadKg: loadKey === "added_load_kg" ? nextBlock.load : "",
      weightPerDumbbellKg: loadKey === "weight_per_dumbbell_kg" ? nextBlock.load : "",
      title: `${label} · ${exercise.loadPattern === "dumbbell_pair" ? "2×" : loadKey === "added_load_kg" ? "+" : ""}${formatKg(nextBlock.load)} · descanso ${denseFormatRest(restSeconds)}`,
      reason: nextBlock.scheme === "S3x8" ? "Completaste 3×12 con margen: sube un paso de carga y vuelve a 3×8." : `Completaste ${denseStrengthSchemeLabel(entry.scheme)} con margen: aumenta las repeticiones manteniendo la carga.`,
    }, exercise);
  }
  if (!denseIsLoadExercise(exercise)) {
  ...
  const loadKey = exercise.loadPattern === "dumbbell_pair" ? "weight_per_dumbbell_kg" : exercise.nature === "weighted_calisthenics" ? "added_load_kg" : "external_load_kg";
  const currentLoad = denseStrengthFieldLoad(exercise, entry);
  ...
  const performance = denseStrengthPerformance(entry);
  const missed = !failed && !performance.complete;
  if (missed) {
    base.direction = "hold";
  ...
  let repsTarget = parts.isRange ? denseStrengthTargetReps(scheme, performance.target) : parts.reps;
  let reason = missed
    ? `Te faltaron repeticiones en alguna serie: repite ${loadKey === "added_load_kg" ? "+" : ""}${formatKg(currentLoad)} hasta completar ${parts.sets}×${repsTarget}.`
    : denseProgressionReason(entry, base.direction, readiness);
  if (parts.isRange && !failed && !missed) {
    const current = denseStrengthTargetReps(scheme, performance.minimum);
    const progress = ["N", "E", "VE"].includes(effort) && readiness !== "low";
    repsTarget = current;
    if (current < parts.repsMax && progress) {
      repsTarget = current + 1;
      nextLoad = currentLoad;
      reason = `Doble progresión: sube a ${repsTarget} reps por serie con la misma carga antes de añadir peso.`;
      base.direction = "up";
      base.tone = "green";
    } else if (current >= parts.repsMax && progress) {
      repsTarget = parts.repsMin;
      nextLoad = Math.max(currentLoad + 0.5, denseRoundLoad(currentLoad * 1.025));
      reason = `Completaste todas las series a ${parts.repsMax} reps: sube un paso de carga y vuelve a ${parts.repsMin}.`;
      base.direction = "up";
      base.tone = "green";
    } else if (nextLoad >= currentLoad) {
      nextLoad = currentLoad;
      base.direction = "hold";
      base.tone = "neutral";
      reason = `Consolida ${parts.sets}×${repsTarget} con la misma carga antes de progresar.`;
    }
  }
  return denseMaybeDeload(
    {
      ...
      title: `${label}${parts.isRange ? ` (${repsTarget} reps)` : ""} · ${exercise.loadPattern === "dumbbell_pair" ? "2×" : loadKey === "added_load_kg" ? "+" : ""}${formatKg(nextLoad)} · descanso ${denseFormatRest(restSeconds)}`,
      reason,
    },
    exercise,
  );
...
function denseEstimatedLoadSuggestion(exercise, scheme, readiness = "normal") {
  ...
  return {
    ...
    loadKey: exercise.loadPattern === "dumbbell_pair" ? "weight_per_dumbbell_kg" : exercise.nature === "weighted_calisthenics" ? "added_load_kg" : "external_load_kg",
...
function denseMaybeDeload(suggestion, exercise) {
  ...
  if (suggestion.type === "load" && suggestion.loadKey) {
    const current = denseSuggestionLoadValue(suggestion);
    ...
    if (next !== "") {
      ...
      out[key] = next;
      out.title = `${scheme} · ${key === "weightPerDumbbellKg" ? "2×" : key === "addedLoadKg" ? "+" : ""}${formatKg(next)}`;
    }
...
function denseProgressionSuggestion(exercise, readiness = "normal", schemeFilter = "") {
  ...
  if (denseIsStrengthScheme(schemeFilter)) {
    const latest = [...getDenseEntries()].filter((item) => item.exercise_id === exercise.id && !item.deleted_at && item.nature === exercise.nature && denseIsStrengthScheme(item.scheme))
      .sort((a, b) => (b.created_at || b.date || "").localeCompare(a.created_at || a.date || ""))[0];
    const next = latest && denseStrengthNextBlock(exercise, latest, readiness);
    if (next?.scheme === schemeFilter) return denseStrengthProgressionSuggestion(exercise, latest, schemeFilter, readiness, next);
  }
  // Scheme-aware memory:
...
function denseSuggestionLoadValue(suggestion) {
  const field = { external_load_kg: "externalLoadKg", added_load_kg: "addedLoadKg", weight_per_dumbbell_kg: "weightPerDumbbellKg", assist_load_kg: "assistLoadKg" }[suggestion?.loadKey] || (suggestion?.type === "assist" ? "assistLoadKg" : null);
  return field ? Number(suggestion[field] ?? 0) : 0;
}
...
function denseFormDefaults() {
  ...
  if (draftEntry) {
    ...
    return {
      ...
      strengthTargetReps: draftEntry.target_reps_per_set || Number(draftEntry.target_total_reps) / Number(draftEntry.sets) || draftEntry.reps_per_set_avg,
...
function computeDenseEntry(raw) {
  ...
  if (strength) {
    ...
    const repsDone = Array.isArray(raw.reps_done) ? raw.reps_done.map(Number).filter((reps) => Number.isFinite(reps) && reps >= 0) : [];
    const totalRepsS = repsDone.length ? repsDone.reduce((sum, reps) => sum + reps, 0) : totalReps || sets * strength.reps;
